# Install the AWS CLI version 1 Using the Bundled Installer \(Linux, macOS, or Unix\)<a name="install-bundle"></a>
...
+ [Install the AWS CLI version 1 without Sudo \(Linux, macOS, or Unix\)](#install-bundle-user)
...
## Install the AWS CLI version 1 without Sudo \(Linux, macOS, or Unix\)<a name="install-bundle-user"></a>
